...
export async function generateMetadata() {
  ...
  const data = await GetStaticDataTags("privacy");
  ...
  return {
    ...
    openGraph: {
      title: data?.title,
      description: data?.description,
      url: `${configs?.url}/static/privacy-policy`,
...
const Page = async () => {
  ...
  const data = await GetStaticData("privacy");

  return (
    <>
      <StaticHeader title={"Privacy Policy"} data={"/static/privacy-policy"} />
