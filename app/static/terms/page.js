...
export async function generateMetadata() {
  ...
  const data = await GetStaticDataTags("terms");
...
const Page = async () => {
  ...
  const data = await GetStaticData("terms");

  return (
    <>
      <StaticHeader title={"Terms & Condition"} data={"/static/terms"} />
